...
@include('admin.contents.service._modal')
@endsection
...
<script type="text/javascript">
    var url = {
        detail: "{{route('dashboard_services_detail')}}",
        delete: "{{route('dashboard_services_delete')}}",
        submit: "{{route('dashboard_services_post')}}",
        table: "{{route('dashboard_services_table')}}"
    };
    var table;
