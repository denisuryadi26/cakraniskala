...
@include('admin.contents.pengurus._modal')
@endsection
...
<script type="text/javascript">
    var url = {
        detail: "{{route('dashboard_penguruses_detail')}}",
        delete: "{{route('dashboard_penguruses_delete')}}",
        submit: "{{route('dashboard_penguruses_post')}}",
        table: "{{route('dashboard_penguruses_table')}}"
    };
    var table;
