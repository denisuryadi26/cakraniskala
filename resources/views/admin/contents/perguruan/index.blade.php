...
@include('admin.contents.perguruan._modal')
@endsection
...
<script type="text/javascript">
    var url = {
        detail: "{{route('dashboard_perguruans_detail')}}",
        delete: "{{route('dashboard_perguruans_delete')}}",
        submit: "{{route('dashboard_perguruans_post')}}",
        table: "{{route('dashboard_perguruans_table')}}"
    };
    var table;
