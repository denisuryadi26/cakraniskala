...
@section('content')
    ...
    @include('admin.contents.sequencecode._modal')
@endsection
...
@section('script')
    ...
    <script type="text/javascript">
        var url = {
            detail : "{{route('dashboard_sequencecodes_detail')}}",
            delete : "{{route('dashboard_sequencecodes_delete')}}",
            submit : "{{route('dashboard_sequencecodes_post')}}",
            table : "{{route('dashboard_sequencecodes_table')}}"
        };
        var table;
        ...
        $(document).ready(function () {
            ...
            table = $('#contentTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'sequence_digit', name: 'sequence_digit'},
                    {data: 'type', name: 'type'},
            ...
            $(document).on('click', '.view', function (e) {
                ...
                $.get(url.detail, {id : id}, function (result){
                    ...
                    $('#sequence_digit').val(response.sequence_digit)
