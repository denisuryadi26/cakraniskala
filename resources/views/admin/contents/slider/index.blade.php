...
@include('admin.contents.slider._modal')
@endsection
...
<script type="text/javascript">
    var url = {
        detail: "{{route('dashboard_sliders_detail')}}",
        delete: "{{route('dashboard_sliders_delete')}}",
        submit: "{{route('dashboard_sliders_post')}}",
        table: "{{route('dashboard_sliders_table')}}"
    };
    var table;
