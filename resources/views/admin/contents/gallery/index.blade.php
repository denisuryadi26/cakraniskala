...
@include('admin.contents.gallery._modal')
@endsection
...
<script type="text/javascript">
    var url = {
        detail: "{{route('dashboard_galleries_detail')}}",
        delete: "{{route('dashboard_galleries_delete')}}",
        submit: "{{route('dashboard_galleries_post')}}",
        table: "{{route('dashboard_galleries_table')}}"
    };
    var table;
