...
<head>
    ...
    <div class="teams bg-light mt-5 py-5">
        <div class="container">
            <div class="title-container ">
                <h2 class="text-center fw-bold ">PENGURUS KAMI</h2>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3" data-aos="fade-up">
                    <div class="card" style="width: 18rem;">
                        <img src="{{asset('storage/images/')}}/{{$pengurus->image}}" class="card-img-top" alt="...">
                        <div class="card-body text-center">
                            <h5 class="card-title text-bold">{{$pengurus->title}}</h5>
                            <p class="card-text text-muted">{{$pengurus->description}}</p>
                        </div>
                    </div>
                </div>
                @endforeach
    ...
    <div class="clients mt-5">
        <div class="container">
            <div class="title-container">
                <h2 class="text-center fw-bold">SAUDARA PERGURUAN</h2>
            </div>
            <div class="row mt-5">
                @foreach($perguruans as $client)
